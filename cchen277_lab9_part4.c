...
//test
//enum test_states {test_wait, test_increase, test_decrease} test_state;
...
unsigned char speakerPeriod = 0; //Frequency
...
void FrequencySM() {
     switch(fr_state) {
         case fr_wait:
             ...
             break;
         case fr_increase:
 			fr_state = (tmpA == 0x01) ? fr_increase : fr_wait;
			break;
         case fr_decrease:
 			fr_state = (tmpA == 0x02) ? fr_decrease : fr_wait;
			break;
